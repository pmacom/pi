...
# Check /boot/cmdline.txt for dwc2 module loading
if grep -q "modules-load=dwc2" /boot/cmdline.txt; then
  echo "✅ dwc2 module load setting found in /boot/cmdline.txt"
else
  echo "❌ dwc2 module load setting is missing in /boot/cmdline.txt"
fi
